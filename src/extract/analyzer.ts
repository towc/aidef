...
export async function analyze(scanResult: ScanResult, provider: LLMProvider): Promise<ProjectAnalysis> {
  let fileSummary = '';
  ...
  const prompt = `You are an expert software project analyzer. Your task is to analyze a given project structure and its files to provide a comprehensive ProjectAnalysis in JSON format.
